 ...
 */
//轮播图
var frame = document.getElementsByClassName('frame')[0];//轮播图大盒子
var frame_ul = frame.children[0];//图片列表ul标签
var focus_nav = document.getElementsByClassName('focus_nav')[0];//索引
