...
//顶部导航栏鼠标移入事件
    ...
    function colorChange(selector1, selector2) {
        $("#topNavHL").children(selector1).children(".tri").on("mouseenter", function () {
            $(this).css("cursor", "pointer");
            $("#topNavHL .navHL").children(selector2).children("a").css("color", "rgb(209, 192, 168)");
        });
        $("#topNavHL").children(selector1).children(".tri").on("mouseleave", function () {
    ...
    $(window).on("scroll", function () {
        ...
        if (height > 50 && height < 70 && a == 0) {
            ...
            $(".periodical .nav a").click(function () {
                ...
                $(this).addClass("now").css("background-position-x", "-44px").siblings().removeClass("now").css("background-position-x", "0px");
                idx = $(this).index();
            ...
            setInterval(function () {
                ...
                $(".periodical .nav a").eq(idx).addClass("now").css("background-position-x", "-44px").siblings().removeClass("now").css("background-position-x", "0px");
        ...
        if (height > 480 && height < 530 && b == 0) {
            ...
            setInterval(function () {
                ...
                $(".protects .nav a").eq(idx).addClass("now").css("background-position-x", "-44px").siblings().removeClass("now").css("background-position-x", "0px");
        ...
        if (height > 1200 && height < 1240 && c == 0) {
            c++;
            $(".item3>.icon2").show().css({"top": -120, opacity: 0}).animate({"top": -30, opacity: 1}, 2000);
        }
        ...
        if (height > 2550 && height < 2600 && d == 0) {
            ...
            $(".item4>.child").show().children(".img").css({"right": -60, opacity: 0}).animate({
                "right": -10,
                opacity: 1
            }, 2000);
            $(".item4>.child>.text").css({"left": -60, opacity: 0}).animate({"left": 0, opacity: 1}, 2000);
